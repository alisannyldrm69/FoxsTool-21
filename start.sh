#!/bin/bash
#Code:AlisanYildirimr
#İnstagram: @yildirimsibertim
#Youtube : null
echo -e '\033[31;40;1m 
		   ─────█─▄▀█──█▀▄─█─────
		   ────▐▌──────────▐▌────
      ...
      \e[35m      ☠         Code  : AlisanYildirim     ☠
	  \e[34m☠	     Github : YildirimSiberTim    ☠
	 \e[33m☠  	    Youtube : null   ☠
	\e[32m☠ 	   İnstagram : @yildirimsibertim_      ☠
	
	\e[36m 	 ☾★ ☾★ Yıldırım Siber Tim  ☾★ ☾★	
